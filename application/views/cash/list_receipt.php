...
<div id="modal_cash_receipt_opening_form" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class='modal-body'>
			<form id="form_cash_receipt_opening" action="<?=site_url('cash/receipt/update/open');?>" method="POST" class="form form-horizontal">
...
<div id="modal_cash_receipt_delivery_form" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class='modal-body'>
			<form id="form_cash_receipt_delivery" action="<?=site_url('cash/receipt/update/delivery');?>" method="POST" class="form form-horizontal">
...
<div id="modal_cash_receipt_edit" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 900px; margin-left: -450px; ">
		<div class='modal-header'>
		    <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button>
		    <h3 id='myModalLabel'>收據/發票</h3>
		</div>
		<div class='modal-body'>
			<form id="form_cash_receipt" action="<?=site_url('cash/receipt/update');?>" method="POST" class="form form-horizontal">
				<input type="hidden" name="receipt_no" value=""/>
				<div class="row-fluid">
					<div class="control-group span6">
		...
		<div class='modal-footer'>
			<button type='button' id="open_receipt" name="update" class='btn btn-warning' data-dismiss='modal'>確認</button>
			<button type='button' class='btn btn-primary' data-dismiss='modal'>取消</button>
		</div>
</div>