...
<div class="print_area">
	...
	table table td{
	  ...
	  <tr>
	    <td align="right"><img src="<?=base_url();?>img/CMNST.png" alt="" name="cmnst_logo" style="width:80px;height: 80px;"  id="cmnst_logo" /></td>
	  ...
	  <tr>
	    ...
	    Report Number：</td>
	    <td><input type="hidden" name="application_SN" value="<?=isset($application_SN)?$application_SN:"";?>"/><?=isset($application_ID)?$application_ID:"";?></td>
	  </tr>
	  <tr>
	    <td colspan="4"><br /><p>
	...
	(Optional)</td>
	    ...
	    <p align="right">張志欽<br />
	    Chih-Ching  Chang</p></td>
